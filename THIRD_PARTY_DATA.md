...
The local 2026 Heatwave XGBoost model is trained from the documented NASA/USGS Landsat 22 June 2026 observation, Green Map 2021, Urban Atlas 2021, Soil sealing 2024 and Flanders Land Use 2025 analytical water. Its cached model, held-out predictions and inference grid are not public data and are excluded from normal and GitHub Pages distributions.
