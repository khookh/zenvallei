...
| Soil sealing | JaarBAK 2018-2024, EPSG:31370 | `processing/local-layers` | validated manifest and clipped PMTiles | sealed and unsealed shares of complete Statbel area |
| Flanders Green Map | Groenkaart Vlaanderen 2018 and 2021 from the Agency for Nature and Forests, Government of Flanders, and Digital Flanders Agency | `processing/local-layers` | validated manifest and clipped PMTiles | four official class shares of complete Statbel area |
