...
| Green Map x Urban Atlas comparison | prepared Green Map 2021 focal-density bands and Urban Atlas 2021 polygons | `processing/local-layers/.../groenkaart_urban_atlas.py` | validated manifest, 10 m fabric index and sector, municipality and region statistics | selected-class 100 m green density and Tukey distributions for five urban-fabric classes |
