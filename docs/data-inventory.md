...
| Landsat temperature, local | NASA/USGS Landsat 8/9 Level-2 via Planetary Computer | `processing/local-layers/.../landsat.py` | local manifest and PMTiles | discovery, QA masks, clipping and clear-sky temperature summaries |
| Soil sealing, local | JaarBAK 2018-2024, EPSG:31370 | `processing/local-layers` | local manifest and PMTiles | sealed and unsealed shares of complete Statbel area |
| Flanders Green Map, local | Groenkaart Vlaanderen 2018 and 2021 from the Agency for Nature and Forests, Government of Flanders, and Digital Flanders Agency | `processing/local-layers` | local manifest and PMTiles | four official class shares of complete Statbel area |
| Flanders land use, local | Landgebruik Vlaanderen 2019, 2022 and 2025 from the Department of Environment & Spatial Development, Government of Flanders, plus 2025 parcels from the Agency for Agriculture and Fisheries, Government of Flanders | `processing/local-layers/.../landgebruik.py` | local manifest, PMTiles and clipped parcel GeoJSON | all 19 class shares; parcel share of complete Statbel area and crop-group composition |
...
- EPSG:3857 is used only for visual PMTiles.
