...
| Landsat x JaarBAK comparison | prepared Landsat analytical rasters, native 1 m JaarBAK rasters and official JaarBAK PMTiles | `processing/local-layers/.../landsat_jaarbak.py` | manifest, 30 m distributions, lossless density indexes and exact PMTiles composition | sealed/unsealed temperature distributions; every eligible clear temperature against 100 m density; exact 1 m sealed display below complete Landsat |
