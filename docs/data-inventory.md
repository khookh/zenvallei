...
| Landsat x Urban Atlas comparison, local | prepared Landsat analytical rasters and Copernicus Urban Atlas 2021 polygons | `processing/local-layers/.../landsat_urban_atlas.py` | ignored comparison manifest, distributions and encoded PNGs | unique 50% surface assignment, selected analysis families, fixed-bin temperature distributions and scope summaries |
| Landsat x JaarBAK comparison, local | prepared Landsat analytical rasters and native 1 m JaarBAK rasters | `processing/local-layers/.../landsat_jaarbak.py` | ignored comparison manifest, distributions and encoded PNGs | valid-area averaging, sealed/unsealed majority assignment and fixed-bin temperature distributions |
