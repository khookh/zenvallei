...
describe("active documentation", () => {
  ...
  it("keeps one factual contract and one priority for all eighteen active views", async () => {
    ...
    expect(numberedViews).toHaveLength(18);
    expect(priorities).toHaveLength(18);
